...
final class MockS3Client {
    ...
    ///
    /// - Tag: MockS3Client.listObjectsV2Results
    var listObjectsV2Results: [Result<ListObjectsV2OutputResponse, Error>] = []
}
...
extension MockS3Client: S3ClientProtocol {
    ...
    func listObjectsV2(input: AWSS3.ListObjectsV2Input) async throws -> AWSS3.ListObjectsV2OutputResponse {
        ...
        if let result = listObjectsV2Results.first {
            listObjectsV2Results.removeFirst()
