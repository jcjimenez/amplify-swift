...
/// // underlying plugin will attempt to upload the given file in
/// // a single `PutObject` request if its size is below 1GB.
/// let task = try await Amplify.Storage.uploadFile(
///     key: "ExampleKey",
///     local: localfileURL,
///     options: .init(
///         pluginOptions: AWSStorageUploadFileOptions(
...
///
/// See:
/// * [StorageUploadFileRequestOptions.pluginOptions](x-source-tag://StorageUploadFileRequestOptions.pluginOptions)
/// * [StorageCategoryBehavior.uploadFile](x-source-tag://StorageCategoryBehavior.uploadFile)
///
///
/// - Tag: AWSStorageUploadFileOptions
public struct AWSStorageUploadFileOptions {
    ...
    ///
    /// - Tag: AWSStorageUploadFileOptions.singleUploadSizeLimit
    ...
    /// - Tag: AWSStorageUploadFileOptions.init
